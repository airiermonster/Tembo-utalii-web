...
const mockData = {
  monthlyResponses: [
    ...
    { month: "Feb", responses: 85 },
    { month: "Mar", responses: 120 },
    { month: "Apr", responses: 90 },
    { month: "May", responses: 110 },
  ...
  categoryRatings: [
    { name: "Accommodation", value: 85 },
    { name: "Activities", value: 78 },
    { name: "Food", value: 92 },
            ...
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={mockData.monthlyResponses}>
                    <defs>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Area type="monotone" dataKey="responses" stroke="#0088FE" fillOpacity={1} fill="url(#responses)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
        ...
        >
          <Card>
            ...
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={mockData.categoryRatings}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip />
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    >
                      {mockData.visitorOrigin.map((entry, index) => (
